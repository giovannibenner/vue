        ...
        <div class="card" style="width: 50%; height: auto; padding: 1%;">
            <div class="justify-content-center align-items-center">
                <div class="bg-dark text-white d-flex align-items-center justify-content-center rounded"
                    ...
                    <h3 class="p-4">Atualizar Pedido</h3>
                </div>
                <hr />
                <div class="d-flex row align-items-center justify-content-center" style="width: 100%;">
                    ...
                    <div style="width: 60%;">
                        ...
                        <input type="date" v-model="pedido.data" class="form-control" placeholder="data">
                    </div>
                    <div style="width: 60%;" class="row">
                        <label class="form-label" style="margin-top: 4%;">Vendedor</label>
                        <select v-model="pedido.vendedorId">
                            <option v-for="(vendedor, index) in vendedores" :key="index" :value="vendedor.id"> {{
                                vendedor.id
                    ...
                    <div style="width: 60%;">
                        <button class="btn btn-success" @click="AtualizarPedido"
                            style="margin-top: 4%; width: 100%;">Atualizar</button>
                    </div>
                </div>
            </div>
        </div>
